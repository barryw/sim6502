...
public interface Isim6502Listener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterSystemDeclaration([NotNull] sim6502Parser.SystemDeclarationContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="sim6502Parser.systemDeclaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitSystemDeclaration([NotNull] sim6502Parser.SystemDeclarationContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="sim6502Parser.systemTypeValue"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterSystemTypeValue([NotNull] sim6502Parser.SystemTypeValueContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="sim6502Parser.systemTypeValue"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitSystemTypeValue([NotNull] sim6502Parser.SystemTypeValueContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="sim6502Parser.romDeclaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRomDeclaration([NotNull] sim6502Parser.RomDeclarationContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="sim6502Parser.romDeclaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitRomDeclaration([NotNull] sim6502Parser.RomDeclarationContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="sim6502Parser.romName"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRomName([NotNull] sim6502Parser.RomNameContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="sim6502Parser.romName"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitRomName([NotNull] sim6502Parser.RomNameContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="sim6502Parser.romFilename"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRomFilename([NotNull] sim6502Parser.RomFilenameContext context);
	/// <summary>
